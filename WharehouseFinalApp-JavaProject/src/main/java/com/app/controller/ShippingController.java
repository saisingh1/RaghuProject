...
public class ShippingController {
	...
	private void getPurchaseDtls(Integer shipId,ModelMap map) {
		...
		map.addAttribute("saleOrderId", shipping.getSaleOrder().getSaleOrderId());
		...
		map.addAttribute("nullCount",saleOrderService.getNullShippingStatusCount()+"");
