				...
				<div class="row">
					...
					<div class="col=3">
						<c:if test="${nullCount == '0'}">
							<a
								href="updateOrderStatus?shipId=${shipId}&saleOrderId=${saleOrderId}&shipSatus=SHIPPED"
								class="btn btn-success">Ship All</a>
							<a
